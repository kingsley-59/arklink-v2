...
const ProductCard = ({ item, name }) => {
  let styles = {
    ...
    backgroundImage: `url('/assets/images/${item?.photo}')`,
...
const StaticProductSection = () => {
  const { bathroomCollection, marbleCollection, tilesCollection } = defaultProducts
  return (
    <div className="site-seciton p-5">
      <div className="section-title text-center mb-3">Products</div>
      <Product product='Tiles Collection' data={tilesCollection} />
...
const defaultProducts = {
  tilesCollection: [
    { name: '8 x 6 Tiles', photo: 'tiles-1.jpg' },
    { name: '4 x 6 Tiles', photo: 'tiles-2.jpg' },
    { name: '12 x 9 Tiles', photo: 'tiles-3.jpg' },
    { name: '12 x 10 Tiles', photo: 'tiles-4.jpg' },
    { name: '9 x 9 Tiles', photo: 'tiles-group-1.jpg' },
  ],
  marbleCollection: [
    { name: '', photo: 'marble-1.jpg' },
    { name: '', photo: 'marble-2.jpg' },
    { name: '', photo: 'marble-3.jpg' },
    { name: '', photo: 'marble-group-1.jpg' },
    { name: '', photo: 'marble-1.jpg' },
  ],
  bathroomCollection: [
    { name: '', photo: 'pexel-bathroom-4.jpg' },
    { name: '', photo: 'pexel-bathroom-2.jpg' },
    { name: '', photo: 'pexel-doors-4.jpg' },
    { name: '', photo: 'tile-room.png' },
    { name: '', photo: 'pexel-doors-2.jpg' },
  ]
}